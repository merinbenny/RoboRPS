# RoboRPS
An AI-powered Rock-Paper-Scissors game using YOLO-based hand gesture recognition, OpenCV, Roboflow inference, and Tkinter GUI for real-time computer vision interaction.
# 🎮 AI Rock-Paper-Scissors Game using YOLO

Hi, this is my **AI Rock-Paper-Scissors Game**, a real-time computer vision-based application that allows users to play the classic Rock-Paper-Scissors game against an AI opponent.
